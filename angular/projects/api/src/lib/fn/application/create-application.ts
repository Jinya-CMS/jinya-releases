...
export function createApplication(http: HttpClient, rootUrl: string, params?: CreateApplication$Params, context?: HttpContext): Observable<StrictHttpResponse<Application>> {
...
createApplication.PATH = '/api/admin/application';
